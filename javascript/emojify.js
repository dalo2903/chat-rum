         ...
         /* :-1: */ thumbsdown: /:\-1:/g,
            ...
            function insertEmojicon(args) {
                ...
                if(args.replacer){
                    ...
                    if (elementType !== 'img') {
                        ...
                        emojiElement.setAttribute('src', defaultConfig.img_dir + '/' + args.emojiName + '.gif');
                    }
            ...
            function defaultReplacer(emoji, name) {
                ...
                if (elementType !== 'img') {
                    ...
                    return "<img align='absmiddle' alt=':" + name + ":' class='emoji' src='" + this.config.img_dir + '/' + name + ".gif' title=':" + name + ":' />";
                }
            }
