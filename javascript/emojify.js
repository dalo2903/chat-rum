  ...
  var emojify = (function() {
    ...
    function insertEmojicon(args) {
      ...
      if (args.replacer) {
        ...
        var elementType =
          defaultConfig.tag_type || modeToElementTagType[defaultConfig.mode];
        ...
        if (elementType !== "img") {
          ...
          emojiElement.setAttribute(
            "src",
            defaultConfig.img_dir + "/" + args.emojiName + ".gif"
          );
        }
    ...
    function run(el, replacer) {
      ...
      var elementsBlacklist = new RegExp(
          defaultConfig.blacklist.elements.join("|"),
          "i"
        ),
        classesBlacklist = new RegExp(
          defaultConfig.blacklist.classes.join("|"),
          "i"
        );
    ...
    return {
      ...
      setEmojis: function(emojiNames) {
        namedEmoji = emojiNames;
